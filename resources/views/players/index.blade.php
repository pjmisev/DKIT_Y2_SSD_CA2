        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" action="{{ route('players.index') }}" class="mb-6 bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
                <div class="flex flex-wrap gap-3">
                    ...
                    <button type="submit" class="inline-flex items-center gap-1.5 bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            @if ($player->image)
                                                <img src="{{ Storage::url($player->image) }}" alt="{{ $player->name }}" class="w-8 h-8 rounded-lg object-cover shrink-0">
                                            @else
