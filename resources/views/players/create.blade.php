                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="nationality" id="nationality" value="{{ old('nationality') }}"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500 @error('nationality') border-red-400 @enderror">
                                @error('nationality') <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p> @enderror
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <select name="health_status" id="health_status" required
                                ...
                                @foreach ($healthStatuses as $status)
                                    <option value="{{ $status }}" {{ old('health_status', 'fit') === $status ? 'selected' : '' }}>{{ ucfirst($status) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mt-4">
                        ...
                        <div>
                            ...
                            <select name="linked_to" id="linked_to"
                                ...
                                @foreach ($users as $user)
                                    <option value="{{ $user->id }}" {{ old('linked_to') == $user->id ? 'selected' : '' }}>
