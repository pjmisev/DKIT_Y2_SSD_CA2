    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-5">
                @if ($coach->image)
                    <img src="{{ Storage::url($coach->image) }}" alt="{{ $coach->name }}" class="w-16 h-16 rounded-2xl object-cover shrink-0">
                @else
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="text-sm text-gray-400 mt-0.5">
                        @if ($coach->role) <span>{{ $coach->role }}</span> @endif
                        @if ($coach->role && $coach->team) <span>&middot;</span> @endif
                        @if ($coach->team) <span>{{ $coach->team }}</span> @endif
                    </div>
                </div>
            </div>
                ...
                <div class="col-span-2 sm:col-span-1 bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    ...
                    <dl class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm font-medium text-gray-800">{{ $coach->role ?? '—' }}</dd>
                        </div>
                        <div class="flex justify-between">
