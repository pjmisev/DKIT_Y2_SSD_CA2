        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Detailed coach information</p>
                </div>
            </div>
            @auth
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-soft overflow-hidden">
                <div class="md:flex">
                    <div class="md:w-80 h-72 bg-gradient-to-br from-emerald-500 to-emerald-700 flex items-center justify-center relative overflow-hidden">
                    ...
                    <div class="flex-1 p-8">
                        <div class="flex items-start justify-between mb-6">
                            <div>
                                ...
                                <p class="text-gray-500 mt-1">{{ $info->specialization ?? 'No specialization set' }}</p>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
                            ...
                            <div>
                                <span class="text-gray-400 text-xs">Experience</span>
                                <p class="font-medium text-gray-800 mt-0.5">{{ $info->years_experience ? $info->years_experience.' years' : '—' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if ($info->certifications)
                <div class="bg-white rounded-2xl border border-gray-100 shadow-soft p-8">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">{{ $info->certifications }}</p>
                </div>
            @endif
