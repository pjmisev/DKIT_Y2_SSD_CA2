...
<nav x-data="{ open: false }" class="sticky top-0 z-50 backdrop-blur-xl border-b transition-all duration-300"
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-1">
                ...
                <button @click="toggleTheme()"
                    class="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 hover:bg-white/10"
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700 py-1">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')"
                                    ...
                                    class="flex items-center gap-2 text-red-600 hover:text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:text-red-300 dark:hover:bg-red-900/30">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden" style="border-top: 1px solid rgba(0,0,0,0.1); background-color: {{ $themeColor }};">
        ...
        <div class="border-t px-4 py-3" style="border-color: rgba(0,0,0,0.1);">
            <button @click="toggleTheme()"
                class="mobile-nav-link mobile-nav-link-inactive w-full text-left flex items-center gap-2">
                <template x-if="isDark">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                </template>
                <template x-if="!isDark">
