<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Edit Team</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Update team details</p>
            </div>
        </div>
    </x-slot>
