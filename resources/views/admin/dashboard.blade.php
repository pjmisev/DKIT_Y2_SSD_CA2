    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">System overview and management</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                <a href="{{ route('admin.users.index') }}" class="stat-card bg-white border border-gray-100 shadow-soft hover:shadow-lg hover:-translate-y-0.5 group">
                ...
                <a href="{{ route('players.index') }}" class="stat-card bg-white border border-gray-100 shadow-soft hover:shadow-lg hover:-translate-y-0.5 group">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <span class="text-sm font-medium text-indigo-600 group-hover:text-indigo-700 flex items-center gap-1">Manage players <svg class="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></span>
                    </div>
                </a>
                ...
                <a href="{{ route('coaches.index') }}" class="stat-card bg-white border border-gray-100 shadow-soft hover:shadow-lg hover:-translate-y-0.5 group">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <span class="text-sm font-medium text-emerald-600 group-hover:text-emerald-700 flex items-center gap-1">Manage coaches <svg class="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></span>
                    </div>
                </a>
                ...
                <a href="{{ route('management.index') }}" class="stat-card bg-white border border-gray-100 shadow-soft hover:shadow-lg hover:-translate-y-0.5 group">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <span class="text-sm font-medium text-sky-600 group-hover:text-sky-700 flex items-center gap-1">Manage management <svg class="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></span>
                    </div>
                </a>

                <a href="{{ route('admin.teams.index') }}" class="stat-card bg-white border border-gray-100 shadow-soft hover:shadow-lg hover:-translate-y-0.5 group">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-2xl font-bold text-gray-900">{{ \App\Models\Team::count() }}</div>
                            <div class="text-sm text-gray-500">Teams</div>
                        </div>
                    </div>
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <span class="text-sm font-medium text-amber-600 group-hover:text-amber-700 flex items-center gap-1">Manage teams <svg class="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></span>
                    </div>
                </a>
                ...
                <a href="{{ route('events.index') }}" class="stat-card bg-white border border-gray-100 shadow-soft hover:shadow-lg hover:-translate-y-0.5 group">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <span class="text-sm font-medium text-hoop-600 group-hover:text-hoop-700 flex items-center gap-1">Manage events <svg class="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></span>
                    </div>
                </a>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-soft overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="text-xs font-semibold text-violet-600 hover:text-violet-700 transition-colors">View all</a>
                </div>
