    ...
    <div class="mt-6">
        ...
        <div class="mt-4 grid grid-cols-3 gap-3">
            ...
            <a href="{{ route('auth.provider.redirect', 'google') }}"
               class="w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
            ...
            <!-- Microsoft -->
            <a href="{{ route('auth.provider.redirect', 'microsoft') }}"
               class="w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
