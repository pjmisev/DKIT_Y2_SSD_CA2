<x-guest-layout>
    <div class="mb-6 text-center">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Join your basketball club</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Name -->
        <div>
            <label for="name" class="input-label text-gray-700 dark:text-gray-300">Name</label>
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="input-label text-gray-700 dark:text-gray-300">Confirm Password</label>
    ...
    @if (config('services.google.client_id') || config('services.github.client_id'))
        <div class="divider text-gray-500 dark:text-gray-400 mt-6 mb-5">or sign up with</div>
    ...
    <p class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <a href="{{ route('login') }}" class="text-hoop-600 dark:text-hoop-400 hover:text-hoop-700 dark:hover:text-hoop-300 font-semibold transition-colors">Sign in</a>
    </p>
</x-guest-layout>
