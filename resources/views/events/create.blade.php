<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Add Event</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Schedule a new event</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-soft p-8">
                <form method="POST" action="{{ route('events.store') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <a href="{{ route('events.index') }}" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 font-medium transition-colors">Cancel</a>
